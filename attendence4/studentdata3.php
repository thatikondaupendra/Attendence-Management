...
<html>
    ...
    <nav>
        ...
        <form method='post' action='http://192.168.96.32/Attendence-Management/attendence4/studentdata.php'><label for='yearr'>Enter year:</label><input type='text' name='yearr'/><br><label for='branch'>Enter Branch:</label><input type='text' name='branch'/><input type='submit' name='drops' value='delete all records'></form>